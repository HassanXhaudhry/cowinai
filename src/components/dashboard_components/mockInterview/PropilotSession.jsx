...
const PropilotSession = ({setIsPropilotSessionOpen, setIsLastDivVisible}) => {
  ...
  const handleCreateClick = () => {
    setIsLastDivVisible(true); // Toggle the visibility of the last div in the parent component
    setIsPropilotSessionOpen(false); // Close the PropilotSession component
  };
