  ...
  return (
    ...
    <div className="font-Manrope sm:mx-7 mx-4">
      <div className="flex mt-2 justify-between">
        ...
        <button
          className="h-8 sm:px-6 px-3 cursor-pointer rounded-[5px] text-white sm:text-xs text-[10px] font-semibold
        bg-gradient-to-r from-yellow to-orange mt-2"
        >
          Complete
        </button>
      </div>
