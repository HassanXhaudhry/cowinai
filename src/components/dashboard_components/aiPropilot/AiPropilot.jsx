...
const AiPropilot = ({handleCreateClick}) => {
    ...
    <Fragment>
      ...
      <button className='h-7 px-5 bg-[#4E43FA] text-sm rounded-md font-medium text-white'>Subscribe</button>
        ...
        <div className="text-xl font-semibold pt-3 pl-4" >
          <p className='text-transparent bg-clip-text bg-gradient-to-r from-yellow to-orange'>Al Interview Propilot</p>
