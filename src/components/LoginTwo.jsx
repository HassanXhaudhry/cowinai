      ...
      <Fragment>
          ...
          <div className="bg-white sm:w-[420px] sm:h-[470px] w-[270px] h-[510px] rounded-xl">
            <div className="sm:my-7 sm:mx-16 my-2 mx-8 font-Inter text-lg">
              ...
              <p className="text-xs font-Inter text-[#9A9AB0] py-1">
                Please enter your details to Login to Dashboard
              </p>
              <div>
                <Formik
                  initialValues={{
                    ...
                    >
                      ...
                      <div className="font-Mulish sm:w-[300px] w-[200px]">
                        ...
                        <div className="flex text-xs py-3">
                          <input
                            type="checkbox"
                            className="form-checkbox h-4 w-4 text-black border-black rounded-xs cursor-pointer focus:ring-transparent"
                          />{" "}
                          &nbsp;
                          <div className="flex">
                            <p className="text-[#11142D]">I agree to the </p>
                            <p className="text-[#0071BD] hover:underline cursor-pointer">
                              {" "}
                              Terms & Conditions
                            </p>
                          </div>
              ...
              <div className="flex flex-col items-center">
                ...
                <div className="flex text-xs py-4">
                  <p className="text-[#11142D]">Doesn’t have an Account?</p>
                  &nbsp;
                  <p
        ...
        {showSignup ? (
          <div className="bg-white sm:w-[420px] sm:h-[520px] w-[280px] h-[510px] rounded-xl">
            <div className="sm:mt-2 sm:mx-16 mt-2 mx-6 font-Inter text-lg">
              Signup
                      ...
                      {(formik) => (
                        ...
                        >
                          ...
                          <div className="flex flex-col mt-7">
                            <button
                              type="submit"
                              className="w-[170px] font-Inter h-[36px] bg-[#4E43FA] hover:bg-gradient-to-r from-orange to-yellow rounded-lg text-white text-sm my-3 sm:my-0"
                            >
                              Reset Password
                            </button>
                          </div>
